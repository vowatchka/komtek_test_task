...
![scheme](http://dl4.joxi.net/drive/2022/03/01/0012/1225/795849/49/9ef4f8e0c2.png)
...
* Получение списка справочников, актуальных на указанную дату
    ...
    Получим все справочники, которые начали действовать до указанной даты включительно. Справочники, которые еще не начали действовать на момент указанной даты, не попадут в список.
    Вывод не полностью отформатирован для краткости:
    ```json
    {
      "count": 7,
...
* Получение элементов заданного справочника указанной версии
    ...
    Получим все элементы указанного справочника, которые были добавлены в первой (1) версии.
    Вывод не полностью отформатирован для краткости:
    ```json
    {
      "count": 20,
